...
2. a `GRanges` of the feature `ranges` for all experimentsw ith a metadata 
field called `name`. 
...
## Each entry in the positions dataset has an equivalent metadata "name" entry in the ranges dataset
