...
The outpout of `findConsensusPeakRegions` function is a list containing an 
...
```
In ENCODE bed narrowPeak format, each entry doesn't have a specific name 
associated to it.
...
The consensus regions for chromosome 3 only are calculated 
