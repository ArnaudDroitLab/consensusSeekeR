...
generates narrow peaks outputs. The NarrowPeak format, wichi is used by the 
...
the use of the union of the regions can result in wide consensus ranges.
...
by the use of the features positions, instead of the genomic range, to identify
