...
abstract: The consensusSeekeR package is designed to detect consensus regions inside a group of experiments using genomic positions and genomic ranges.
...
```{r peakRegion, fig.cap = "Two ChIP-Seq peaks. A ChIP-seq peak is defined by a enriched region an a peak position.", echo = FALSE}
