...
is characterized 
by the use of the features positions, instead of the most commonly used 
genomic ranges, to identify the consensus regions.
...
moment that 
the set of features stay the same between two iterations. 
...
found. An exemple of the consensus regions (in green) is shown here using 
...
We thank Imène Boudaoud for her advices on the vignette content.
